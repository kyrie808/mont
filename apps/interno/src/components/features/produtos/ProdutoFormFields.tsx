...
export function ProdutoFormFields({
    ...
    return (
        <>
            ...
            {/* Preço / Custo / Ancoragem — layout difere entre criar e editar */}
            {isEdit ? (
                <>
                    <div className="grid grid-cols-2 gap-4">
                        <Input
            ...
            {showMargem && (
                <div className={isEdit
                    ? 'bg-gray-50 dark:bg-white/5 p-3 rounded-lg flex justify-between items-center'
                    : 'bg-gray-50 dark:bg-white/5 p-3 rounded-lg flex justify-between items-center transition-all animate-in fade-in slide-in-from-left-2'}>
