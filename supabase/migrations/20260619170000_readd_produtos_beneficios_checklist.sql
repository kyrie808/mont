-- Reativa beneficios: checklist por-produto p/ os slides não-combo do carrossel.
-- Aditivo: coluna nullable + append no fim da view (CREATE OR REPLACE aceita coluna nova no fim).
